...
- **Document-autonomous authorization** — access is governed per-document (`doc_member` + owner),
  ...
  each message.
- **Agent path** — a no-DOM conversion path lets agents read and edit documents without
  a browser.
...
<Card title="Use docs day-to-day" icon="messages-square" href="/guides/teams/use-chat-and-docs">
  How chat and docs fit together for a team.
</Card>
