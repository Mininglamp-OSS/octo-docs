...
boundary so the IM core stays swappable. The **search & export** pipeline is optional — it reads
the message store, indexes into OpenSearch through Kafka, and serves batch exports to object
storage.
