...
WebSocket APIs to the clients, orchestrates business logic and agent scheduling,
...
graph LR
  ...
  subgraph core["Application core"]
    server["octo-server<br/>REST + WS · orchestration · agent scheduling"]
...
<Steps>
  ...
  <Step title="Execute">
    Business logic runs — possibly spawning or resuming an agent session. See
