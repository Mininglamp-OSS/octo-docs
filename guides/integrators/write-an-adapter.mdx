...
description: "Bridge a third-party IM stack, AI provider, or data source into Octo as a Lobster-addressable surface."
icon: "cable"
---

An **adapter** bridges an external system — a chat stack, an AI provider, a data source — into
Octo so it becomes a Lobster-addressable surface. Adapters live in
