...
description: "The 31-repository Octo ecosystem — every repo's role, language, and how the pieces fit together."
icon: "diagram-project"
---

Octo is spread across **31 repositories** under
...
| [`octo-fleet`](https://github.com/Mininglamp-OSS/octo-fleet) | Runtime & bot/daemon orchestration (split from server) |
| [`octo-matter`](https://github.com/Mininglamp-OSS/octo-matter) | Task / todo / matter microservice |
| [`octo-smart-summary`](https://github.com/Mininglamp-OSS/octo-smart-summary) | LLM conversation summarization |
| [`octo-mail`](https://github.com/Mininglamp-OSS/octo-mail) | Multi-tenant mail-server kernel (IMAP/JMAP/SMTP/REST) |
...
| [`octo-version-sync`](https://github.com/Mininglamp-OSS/octo-version-sync) | Upstream version aggregator → `version.json` |
