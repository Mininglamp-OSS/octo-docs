...
| Repo | Role | Docs |
|---|---|---|
| [`octo-server`](https://github.com/Mininglamp-OSS/octo-server) | Backend API · orchestration · agent scheduling · drives WuKongIM | [Read →](/concepts/architecture-overview) |
...
| [`octo-marketplace`](https://github.com/Mininglamp-OSS/octo-marketplace) | Skill / MCP marketplace control plane | [Read →](/guides/integrators/marketplace) |
