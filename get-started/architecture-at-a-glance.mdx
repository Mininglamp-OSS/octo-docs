...
![Octo platform architecture: clients and agents connect through nginx to octo-server, which coordinates messaging, services, data stores, search, and shared libraries.](/images/architecture-overview.svg)
