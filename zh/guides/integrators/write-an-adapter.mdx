---
title: "编写一个适配器"
description: "把第三方 IM 技术栈、AI 提供方或数据源桥接进 Octo，成为一个可被智能体寻址的界面。"
icon: "cable"
---

**适配器（adapter）**把一个外部系统——聊天技术栈、AI 提供方、数据源——桥接进
Octo，使其成为一个可被智能体寻址的界面。适配器存放于
...
| 适配器 | 语言 | 亮点 |
|---|---|---|
| Claude Agent SDK 网关 | TypeScript | WS 网关、DH 密钥交换、AES-CBC 分帧、流式、私聊 + 群组、会话持久化 |
