...
- **智能体通路**——一条无 DOM 的转换通路让 Lobster 智能体无需浏览器即可读写文档。

<Note>
  该子系统的范围被严格限定在实时文档同步——它有意不覆盖白板/Excalidraw 功能。授权按文档进行，独立于 Channel 的 ACL。
</Note>
...
<Card title="在日常中使用文档" icon="messages-square" href="/zh/guides/teams/use-chat-docs-tasks">
  聊天、文档与任务如何为团队协同配合。
</Card>
